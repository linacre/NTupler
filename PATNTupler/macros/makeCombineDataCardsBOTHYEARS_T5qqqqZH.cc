...
int main(){
    ...
    const std::string outputDirGeneral = "combinedDataCards_T5qqqqZH_3";
...
//                                             // "mH30_mSquark800",                                       "mH50_mSquark800",  "mH70_mSquark800",  "mH90_mSquark800",  "mH110_mSquark800",  "mH125_mSquark800",
    ...
    int numYearsCount = 0;
    std::vector<unsigned int> yearOfRunVec = {2018};
...
void GetHistograms(std::map<std::string,TH1D*>& h_, const unsigned int& yearOfRun)
{
    ...
    if (yearOfRun == 2018 && use2017as2018 == false) {
        ...
        histoNameVec.push_back("T5qqqqZH_1000");
        histoNameVec.push_back("T5qqqqZH_1500");
        histoNameVec.push_back("T5qqqqZH_1500_ZH");
        histoNameVec.push_back("T5qqqqZH_2200");
    }
    else {
