...
for i in range(0, len(three_x_points_vec)-1):
	...
	print "2016 ht1500to2500 F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht1500to2500_2016) + " = " + str(integral_S["fullCutsData_anti_ht1500to2500_2016"]) + " / " + str(2 * integral_U["fullCutsData_anti_ht1500to2500_2016"])
	print "2016 ht2500to3500 F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht2500to3500_2016) + " = " + str(integral_S["fullCutsData_anti_ht2500to3500_2016"]) + " / " + str(2 * integral_U["fullCutsData_anti_ht2500to3500_2016"])
	print "2016 MC ht3500toInf F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht3500toInf_2016_MC) + " = " + str(integral_S["fullCutsMC_anti_ht3500toInf_2016"]) + " / " + str(2 * integral_U["fullCutsMC_anti_ht3500toInf_2016"])	
	...
	print "2017 ht1500to2500 F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht1500to2500_2017) + " = " + str(integral_S["fullCutsData_anti_ht1500to2500_2017"]) + " / " + str(2 * integral_U["fullCutsData_anti_ht1500to2500_2017"])
	print "2017 ht2500to3500 F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht2500to3500_2017) + " = " + str(integral_S["fullCutsData_anti_ht2500to3500_2017"]) + " / " + str(2 * integral_U["fullCutsData_anti_ht2500to3500_2017"])
	print "2017 MC ht3500toInf F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht3500toInf_2017_MC) + " = " + str(integral_S["fullCutsMC_anti_ht3500toInf_2017"]) + " / " + str(2 * integral_U["fullCutsMC_anti_ht3500toInf_2017"])	
	...
	print "2018 ht1500to2500 F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht1500to2500_2018) + " = " + str(integral_S["fullCutsData_anti_ht1500to2500_2018"]) + " / " + str(2 * integral_U["fullCutsData_anti_ht1500to2500_2018"])
	print "2018 ht2500to3500 F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht2500to3500_2018) + " = " + str(integral_S["fullCutsData_anti_ht2500to3500_2018"]) + " / " + str(2 * integral_U["fullCutsData_anti_ht2500to3500_2018"])
	print "2018 MC ht3500toInf F_" + str(iMR) + " = " + str(ratio__antiS_over_antiUnD__fullCuts_anti_ht3500toInf_2018_MC) + " = " + str(integral_S["fullCutsMC_anti_ht3500toInf_2018"]) + " / " + str(2 * integral_U["fullCutsMC_anti_ht3500toInf_2018"])	
