...
int main(int argc, char** argv){
    ...
    // ONE: save info
    std::string outputDir = "plotting_compare_samples_2017_softdropmassAllFit"; // where we are going to save the output plots (should include the samples name, and any important features)
    ...
    // TH1D hTemplate("hTemplate", ";fatJetA SoftDropMass (GeV);fraction of events / bin", 12, 4.76648814, 142.2);
    TH1D hTemplate("hTemplate", ";fatJetA SoftDropMass (GeV);fraction of events / bin", 400, 0, 200);
...
*/
                    ...
                    mH30_mSusy1200.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017/mH30p0_mSusy1200p0_ratio0p99_splitting0p1/flatTree.root", cutToApply.c_str(), 1, "weight_combined");
                    // mH30_mSusy1200.NormalisePlot();
                    mH30_mSusy1200.FitGaus();
                    plotEntryVec2.push_back(mH30_mSusy1200);

                    PlotEntry mH35_mSusy1200 = PlotEntry("mH35_mSusy1200", hTemplate, varToPlot.c_str(), luminosity);
                    mH35_mSusy1200.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017/mH35p0_mSusy1200p0_ratio0p99_splitting0p1/flatTree.root", cutToApply.c_str(), 1, "weight_combined");
                    // mH35_mSusy1200.NormalisePlot();
                    mH35_mSusy1200.FitGaus();
                    plotEntryVec2.push_back(mH35_mSusy1200);

                    PlotEntry mH40_mSusy1200 = PlotEntry("mH40_mSusy1200", hTemplate, varToPlot.c_str(), luminosity);
                    mH40_mSusy1200.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017/mH40p0_mSusy1200p0_ratio0p99_splitting0p1/flatTree.root", cutToApply.c_str(), 1, "weight_combined");
                    // mH40_mSusy1200.NormalisePlot();
                    mH40_mSusy1200.FitGaus();
                    plotEntryVec2.push_back(mH40_mSusy1200);

                    PlotEntry mH50_mSusy1200 = PlotEntry("mH50_mSusy1200", hTemplate, varToPlot.c_str(), luminosity);
                    mH50_mSusy1200.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017/mH50p0_mSusy1200p0_ratio0p99_splitting0p1/flatTree.root", cutToApply.c_str(), 1, "weight_combined");
                    // mH50_mSusy1200.NormalisePlot();
                    mH50_mSusy1200.FitGaus();
                    plotEntryVec2.push_back(mH50_mSusy1200);
                    ...
                    mH90_mSusy1200.FitGaus();
                    plotEntryVec2.push_back(mH90_mSusy1200);

                    PlotEntry mH110_mSusy1200 = PlotEntry("mH110_mSusy1200", hTemplate, varToPlot.c_str(), luminosity);
                    mH110_mSusy1200.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017/mH110p0_mSusy1200p0_ratio0p99_splitting0p1/flatTree.root", cutToApply.c_str(), 1, "weight_combined");
                    // mH110_mSusy1200.NormalisePlot();
                    mH110_mSusy1200.FitGaus();
                    plotEntryVec2.push_back(mH110_mSusy1200);

                    PlotEntry mH125_mSusy1200 = PlotEntry("mH125_mSusy1200", hTemplate, varToPlot.c_str(), luminosity);
                    mH125_mSusy1200.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017/mH125p0_mSusy1200p0_ratio0p99_splitting0p1/flatTree.root", cutToApply.c_str(), 1, "weight_combined");
                    // mH125_mSusy1200.NormalisePlot();
                    mH125_mSusy1200.FitGaus();
                    plotEntryVec2.push_back(mH125_mSusy1200);
