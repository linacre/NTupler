...
for signalDir in signalDirs:
    ...
    f.write("periodic_hold                   = (CurrentTime - EnteredCurrentStatus > 18000)\n")
    ...
    g.write("combine -M FitDiagnostics --saveShapes --saveWithUncertainties --saveOverallShapes --preFitValue 0 --robustFit 1 --trackParameters rgx{ch[0-9]+_alpha} --trackErrors rgx{ch[0-9]+_alpha} --mass %s --keyword-value %s=%s %s\n" % (higgsMass, keyword, susyMass, fileToUseTXT) )
    g.write("python /opt/ppd/scratch-2021/xxt18833/CMSSW_10_2_12/src/HiggsAnalysis/CombinedLimit/test/diffNuisances.py -a fitDiagnosticsTest.root -g plots.root &> diffNuisances.log &\n")
