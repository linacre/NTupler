...
int main(int argc, char** argv){
    ...
    // ONE: save info
    std::string outputDir = "plotting_compare_samples_2017_forpaper_new"; // where we are going to save the output plots (should include the samples name, and any important features)
    ...
    std::vector<std::vector<std::string>> cut2_ak8Dbt = { {"Off","Max","Off","Max"} }; // 4 elements in sub-vector: 1st for fatJetA min, 2nd for fatJetA max, 3rd for fatJetB min, 4th for fatJetB max --> "Off", "Loose", "Med1", "Med2", "Tight", "Max"
    std::vector<int> cut3_ak8Pt = {170};
    std::vector<std::vector<int>> cut4_ht = { {1200,99999} }; // these are HT bins, not just cuts (NB: use 99999 for a maximum)
    std::vector<std::vector<int>> cut5_ak4Pt = { {-1,-1} }; // (2 elements in sub-vector, 1st for leading pt, 2nd for seconary pt)
        ...
        for (size_t iCut3 = 0; iCut3 < cut3_ak8Pt.size(); ++iCut3){
            for (size_t iCut4 = 0; iCut4 < cut4_ht.size(); ++iCut4){        
                for (size_t iCut5 = 0; iCut5 < cut5_ak4Pt.size(); ++iCut5){
                    ...
                    WJets.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017_forTablesOnly/WJets/flatTree.root", cutToApply.c_str(), 34.00, "weight_combined");
                    WJets.NormalisePlot(); // OPTIONAL: toggle on or off
                    plotEntryVec2.push_back(WJets);

                    PlotEntry ZJets = PlotEntry("ZJets", hTemplate, varToPlot.c_str(), luminosity);
                    ZJets.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017_forTablesOnly/ZJets/flatTree.root", cutToApply.c_str(), 18.69, "weight_combined");
                    ZJets.NormalisePlot(); // OPTIONAL: toggle on or off
                    plotEntryVec2.push_back(ZJets);
                    */


                    PlotEntry QCD = PlotEntry("Multijet", hTemplate, varToPlot.c_str(), luminosity);
                    // PlotEntry QCD = PlotEntry("No fatJetB Mass Cut", hTemplate, varToPlot.c_str(), luminosity);
                    QCD.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017_forTablesOnly/QCD_HT1000to1500/flatTree.root", cutToApply.c_str(), 1005, "weight_combined");
                    QCD.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017_forTablesOnly/QCD_HT1500to2000/flatTree.root", cutToApply.c_str(), 101.8, "weight_combined");
                    QCD.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017_forTablesOnly/QCD_HT2000toInf/flatTree.root", cutToApply.c_str(), 20.54, "weight_combined");
                    ...
                    plotEntryVec2.push_back(VJets);

                    // SIGNAL
                    /*
                    PlotEntry mH70_mSusy1200 = PlotEntry("M_{H}=70 GeV, M_{S}=1200 GeV", hTemplate, varToPlot.c_str(), luminosity);
                    ...
                    PlotEntry mH70_mSusy2000 = PlotEntry("M_{H}=70 GeV, M_{S}=2000 GeV", hTemplate, varToPlot.c_str(), luminosity);
                    ...
                    PlotEntry mH70_mSusy2800 = PlotEntry("M_{H}=70 GeV, M_{S}=2800 GeV", hTemplate, varToPlot.c_str(), luminosity);
                    ...
                    */
                    ...
                    PlotEntry mH90_mSusy1200 = PlotEntry("M_{H_{1}}=90, M_{SUSY}=1200", hTemplate, varToPlot.c_str(), luminosity);
                    mH90_mSusy1200.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017/mH90p0_mSusy1200p0_ratio0p99_splitting0p1/flatTree.root", cutToApply.c_str(), 1, "weight_combined");
                    mH90_mSusy1200.NormalisePlot();
                    plotEntryVec2.push_back(mH90_mSusy1200);

                    PlotEntry mH90_mSusy2000 = PlotEntry("M_{H_{1}}=90, M_{SUSY}=2000", hTemplate, varToPlot.c_str(), luminosity);
                    mH90_mSusy2000.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017/mH90p0_mSusy2000p0_ratio0p99_splitting0p1/flatTree.root", cutToApply.c_str(), 1, "weight_combined");
                    mH90_mSusy2000.NormalisePlot();
                    plotEntryVec2.push_back(mH90_mSusy2000);

                    PlotEntry mH90_mSusy2600 = PlotEntry("M_{H_{1}}=90, M_{SUSY}=2600", hTemplate, varToPlot.c_str(), luminosity);
                    mH90_mSusy2600.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017/mH90p0_mSusy2600p0_ratio0p99_splitting0p1/flatTree.root", cutToApply.c_str(), 1, "weight_combined");
                    mH90_mSusy2600.NormalisePlot();
                    plotEntryVec2.push_back(mH90_mSusy2600);
...
/*
                    ...
                    plotElement_Data.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2019_01_01/2017/JetHT_Run2017TOTAL/flatTree.root", cutToApply.c_str());
...
*/
                    ...
                    // QCD_A.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/mc16/QCD_HT1000to1500_ht1499plus/flatTree.root", cutToApplyA.c_str(), 1206);
                    // QCD_A.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/mc16/QCD_HT1500to2000_ht1499plus/flatTree.root", cutToApplyA.c_str(), 120.4);
                    // QCD_A.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/mc16/QCD_HT2000toInf_ht1499plus/flatTree.root", cutToApplyA.c_str(), 25.25);
                    ...
                    // DATA_A.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/data16/JetHT_Run2016Total_ht1499plus/flatTree.root", cutToApplyA.c_str());
                    // DATA_A.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/data17/JetHT_Run2017TOTAL_ht1499plus/flatTree.root", cutToApplyA.c_str());
                    ...
                    // DATA_B.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/data16/JetHT_Run2016Total_ht1499plus/flatTree.root", cutToApplyB.c_str());
                    // DATA_B.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/data17/JetHT_Run2017TOTAL_ht1499plus/flatTree.root", cutToApplyB.c_str());
                    ...
                    // DATA_C.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/data16/JetHT_Run2016Total_ht1499plus/flatTree.root", cutToApplyC.c_str());
                    // DATA_C.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/data17/JetHT_Run2017TOTAL_ht1499plus/flatTree.root", cutToApplyC.c_str());
                    ...
                    // DATA_D.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/data16/JetHT_Run2016Total_ht1499plus/flatTree.root", cutToApplyD.c_str());
                    // DATA_D.AddInput("/mercury/data2/linacre/Joe_backupfromScratch/xap79297/Analysis_boostedNmssmHiggs/flatTrees_2018_08_03/data17/JetHT_Run2017TOTAL_ht1499plus/flatTree.root", cutToApplyD.c_str());
...
*/
                    ...
                    plot.AddLegend(0.20, 0.60, 0.16, 0.42); // bottom left (wide 4)
