...
int main(int argc, char** argv){
    ...
    // ONE: save info
    std::string outputDir = "plotting_compare_samples_2017_forpaper_1200"; // where we are going to save the output plots (should include the samples name, and any important features)
    ...
    TH1D hTemplate("hTemplate", ";H_{T} [GeV];Fraction of events / 100 GeV", 53, 1200, 6500);
...
*/
                    ...
                    plot.AddLegend_cDSPaper(0.18, 0.60, 0.16, 0.46); // bottom left (wide 4)
