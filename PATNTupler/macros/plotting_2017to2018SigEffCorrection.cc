...
/*
                    ...
                    Numerator_mH70_mSusy2000_2017.AddInputEfficiency((treepath+"nmssmSignalCascadeV05_mH70p0_mSusy2000_2017/flatTree.root").c_str(), cutToApply_Numerator.c_str(), dbtCut_SR.c_str(), true);
