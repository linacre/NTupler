...
uniqueName = 'T5qqqqZH_CMSSW10212' # name for this ntuple production (include commit hash so it is unique and can be traced) 
...
config.JobType.psetName = 'nTupleProduction_grid.py'
...
config.Data.inputDataset = '/SMS-T5qqqqZH-mGluino-1000to2500_TuneCP2_13TeV-madgraphMLM-pythia8/RunIIAutumn18MiniAOD-GridpackScan_102X_upgrade2018_realistic_v15-v1/MINIAODSIM'
...
config.Data.outLFNDirBase = '/store/user/linacre/ntuples/2018/MC' # Wherever you want the ntuples to go on the RAL T2
