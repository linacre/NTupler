...
public:
	...
	void AddInput2018squark(const std::string&, const std::string&, const double&, const std::string& = ""); // flatTree address, selection cut, sample cross-section (this is for MC), string of the SF weights
	void AddInputFromGrid(const std::string&, const std::string&, const double&, const std::string& = ""); // flatTree address, selection cut, sample cross-section (this is for MC), string of the SF weights
